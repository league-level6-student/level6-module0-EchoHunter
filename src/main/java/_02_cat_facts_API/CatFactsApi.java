...
import _02_cat_facts_API.data_transfer_objects.catModel;
...
public class CatFactsApi {
    ...
    public String findCatFact(){
        ...
        String[] stringArray= getCatFact().split("[\\[\\]]");
